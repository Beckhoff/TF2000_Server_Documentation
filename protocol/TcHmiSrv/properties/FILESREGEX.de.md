# Spezielle Einstellungen und Berechtigungen für bestimmte Dateien oder Verzeichnisse die auf den angegebenen regulären Ausdruck zutreffen.
...
| - | - |
| Domain | `"TcHmiSrv"` |
| Vollständiger Symbol-Pfad | `"TcHmiSrv.Config::FILESREGEX"` |
